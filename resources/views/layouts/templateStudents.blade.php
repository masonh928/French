        ...
        <div id="container" class="flex min-h-screen h-full">
            <div id="sidebar" class="w-1/6 bg-gray-800 text-center text-gray-300 py-8">
                <ul>
                    ...
                    <li><a class="inline-block rounded px-4 py-2 hover:bg-gray-700 hover:text-white mb-4" href="#">View Assignments</a></li>
                    <li><a class="inline-block rounded px-4 py-2 hover:bg-gray-700 hover:text-white mb-4" href="#">View Quizzes</a></li>
